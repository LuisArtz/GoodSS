...
public class Main extends JavaPlugin {
    ...
    public void onEnable() {
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.DARK_AQUA + "==================");
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "Good" + ChatColor.WHITE + "SS" + ChatColor.AQUA + " By LuisArtz" + ChatColor.WHITE + " v7.0");
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.AQUA + "Running in " + ChatColor.WHITE + Bukkit.getServerName());
        Bukkit.getServer().getConsoleSender().sendMessage(ChatColor.DARK_AQUA + "==================");
        // Register all ymls
        saveDefaultConfig();
        registerEvents();
